...
Support của các item là $\operatorname{sup}(a)=4$, $\operatorname{sup}(b)=3$, $\operatorname{sup}(c)=2$; cả ba đều đạt ngưỡng. Mỗi giao dịch là tập con của giao dịch dài hơn (cấu trúc lồng nhau $\{a\}\subset\{a,b\}\subset\{a,b,c\}$), nên khi chèn theo thứ tự support giảm dần $a,b,c$, mọi giao dịch dùng chung tiền tố và FP-tree co thành một đường:
\[
    root \rightarrow a:4 \rightarrow b:3 \rightarrow c:2.
\]
