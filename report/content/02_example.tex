...
\begin{table}[H]
    \centering
    \caption{CSDL toy dùng để minh hoạ FP-Growth.}
    \label{tab:toy-db}
    \begin{tabular}{c c}
        \toprule
        Giao dịch & Item \\
...
Chèn tuần tự các giao dịch trong Bảng \ref{tab:toy-ordered} tạo ra FP-tree đã minh hoạ ở Hình \ref{fig:fptree-toy}. Từ cây này, thuật toán khai thác từng item thông qua conditional pattern base; kết quả từng bước được trình bày trong Bảng \ref{tab:toy-conditional}:
