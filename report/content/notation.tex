...
Phần này tổng hợp các khái niệm và ký hiệu được dùng nhất quán xuyên suốt báo cáo, nhằm tránh lặp lại định nghĩa ở từng phần. Các định nghĩa hình thức đầy đủ được trình bày ở Mục \ref{sec:theory}; ở đây chỉ liệt kê để tiện tra cứu. Trừ khi nói rõ là tương đối, mọi giá trị support trong báo cáo đều là support tuyệt đối (đếm số giao dịch).
