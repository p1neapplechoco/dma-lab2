...
Tính ổn định kiểu của cơ chế FP-tree này được cả hai chiến lược khai thác maximal sử dụng: baseline naive-maximal chạy thẳng trên \texttt{FPGrowthOpt}, còn FP-Max dùng lại cùng cơ chế cây và cơ sở mẫu điều kiện. Hiệu quả tổng thể của tối ưu được đo ở Mục \ref{sec:implementation-fpmax} và Mục \ref{sec:evaluation}.
