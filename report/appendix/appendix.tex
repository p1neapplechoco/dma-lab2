...
Phụ lục này tóm tắt các bước tái lập toàn bộ mã nguồn, kiểm thử và thực nghiệm của đồ án. Nội dung tương ứng với tệp \texttt{README.md} trong kho mã nguồn; mọi lệnh đều chạy từ thư mục gốc của repo.

\subsection{Cấu trúc thư mục}

\begin{itemize}
    \item \texttt{src/}: package Julia \texttt{FrequentItemsetMining} (FP-Growth cơ bản, FP-Growth tối ưu, FP-Max, sinh luật kết hợp, I/O).
...
juliaup add 1.12      # tùy chọn: ghim đúng phiên bản đã kiểm thử
...
\begin{lstlisting}[language=bash, caption={Khai thác itemset.}]
